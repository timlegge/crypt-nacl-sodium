...
B<Note> Deprecated. Define I<INCLUDE_DEPRECATED> to include

    perl Makefile.PL -Dyes # to define INCLUDE_DEPRECATED
...
The B<salsa208> bytes and xor functions have been deprecated and are not included
by default.  To include the deprecated functions use:

    perl Makefile.PL -Dyes
